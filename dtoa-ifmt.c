...
// For mode 'r', s[-sgn]   .. s[len+5] must be available
// For mode 'e', s[-sgn-1] .. s[len+5] must be available
// For mode 'g', s[-sgn-5] .. s[len+5] must be available
// -> s[-6] .. s[len+5] is enough for ALL modes
