...
def dec_err(x, m0=1e28/2**94):          # chopped 30+ digits
    return (4 - 2*(x<m0)) / x           # if x<m0, scale by 2**95

def scale8(x, dec_err=dec_err):
...
# PROVE: max ulp <= 25
# ====================
# Scale 6 times or less
#     max rel error = 7.9228 + 2.9026*5 + 1/m
#     max abs error = 22.4358 m + 1 = 23 ulp
#
# Scale 7 times = (1e-73,1e60)x4 + (1e-73,1e60,1e25,1e12)x2 + final
#     max rel error = 7.9228 + 2.7402*4 + 2.9026*2 + 1/m
#     max abs error = 24.6888 m + 1 = 25 ulp
#
# Scale 8 times = 1e-73 x5 + (1e25,1e12)x2 + final
#     1e-73 = 0.70674 / 2^242
